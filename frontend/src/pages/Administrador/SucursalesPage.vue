<template>
  <AdminLayout :key="$route.path">
    <div class="sucursales-page">
      <!-- Header con título -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Gestión de Sucursales</h1>
      ...
      <div v-if="loading" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
        ...
        <p class="mt-2 text-gray-600">Cargando sucursales...</p>
      </div>
      ...
      <div v-else class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="sucursal in filteredSucursales" :key="sucursal.id" class="hover:bg-gray-50">
                <!-- ID -->
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ sucursal.id }}</td>
        ...
        <div v-if="filteredSucursales.length === 0" class="text-center py-12">
          ...
          <p class="mt-1 text-sm text-gray-500">Comienza agregando una nueva sucursal.</p>
        </div>
      </div>
