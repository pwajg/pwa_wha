      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <form @submit.prevent="guardarConfiguracionSistema">
            <div class="space-y-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Código de Encomienda (Prefijo)</label>
                <input
                  v-model="configuracion.sistema.prefijoCodigo"
                  type="text"
                  placeholder="ENC"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tiempo de Retención (días)</label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Valor Mínimo de Encomienda</label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Valor Máximo de Encomienda</label>
                <input
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
        ...
        <form @submit.prevent="guardarConfiguracionSeguridad">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tiempo de Sesión (minutos)</label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Intentos de Login Máximos</label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tiempo de Bloqueo (minutos)</label>
                <input
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
        ...
        <form @submit.prevent="guardarConfiguracionNotificaciones">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="space-y-4">
              <h4 class="font-medium text-gray-800 dark:text-white">SMS</h4>
              <div class="space-y-3">
                <div class="flex items-center">
                  <input
            ...
            <div class="space-y-4">
              <h4 class="font-medium text-gray-800 dark:text-white">Push</h4>
              <div class="space-y-3">
                <div class="flex items-center">
                  <input
